...
@rem Run scanstate
scanstate T:\MigData\%computerName% /ue:NETID\%USERNAME% /i:MigDocs.xml /i:MigApp-with-Office2016.xml /i:Mig-SecureCRT.xml /i:MigApp-WinSCP-standalone.xml /i:MigApp-ExcelLockboxMacro.xml /v:13 /l:T:\MigData\%computerName%\scanstate.log /c
pause
