...
@rem Run scanstate
loadstate T:\MigData\%whichProfile% /ue:*\* /ui:NETID\%whichProfile% /i:MigDocs.xml /i:MigApp-with-Office2016.xml /i:Mig-SecureCRT.xml /i:MigApp-WinSCP-standalone.xml/v:13 /l:T:\MigData\%whichProfile%\loadstate.log
pause
